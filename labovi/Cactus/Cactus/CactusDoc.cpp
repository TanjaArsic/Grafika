...
CCactusDoc::CCactusDoc() noexcept
{
...
void CCactusDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CCactusDoc::InitializeSearchContent()
{
...
void CCactusDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
